...
class SayHello(App):
    ...
    def project_page(self, instance):
    ...
    def active_accont_page_func(self, instance):
        self.window.clear_widgets()
    ...
    def active_account_func(self, instance):
        try:
    ...
    def deactive_accont_page_func(self, instance):
        self.window.clear_widgets()
    ...
    def deactive_account_func(self, instance):
        try:
    ...
    def make_proj_fun(self, instance):
        self.window.clear_widgets()
    ...
    def make_proj_button_fun(self, instance):
        try:
    ...
    def see_proj_fun(self, instance):
        self.window.clear_widgets()
    ...
    def see_leader_fun(self, instance):
        try:
    ...
    def see_member_fun(self, instance):
        self.window.cols = 1
        try:
    ...
    def edit_proj_fun(self, instance):
        self.window.cols = 1
        try:
            self.window.clear_widgets()
            ...
            self.tasks.bind(on_press=self.duty_page_link)
    ...
    def add_member_func(self, instance):
        try:
            self.window.clear_widgets()
    ...
    def add_members_func(self, instance):
    ...
    def delete_member_func(self, instance):
        try:
            self.window.clear_widgets()
    ...
    def delete_members_func(self, instance):
